...
namespace PetStore.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            SD.ShoppingApiBase = Configuration["ServiceUrls:ShoppingCartAPI"]; 
               SD.CouponApiBase = Configuration["ServiceUrls:CouponApiBase"];
